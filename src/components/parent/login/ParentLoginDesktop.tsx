...
export function ParentLoginDesktop({
  nis,
  setNis,
  password,
  setPassword,
  ...
  return (
    <div className="hidden lg:flex lg:w-full min-h-screen bg-[#F4F7FC] font-sans antialiased">
      {/* Left Pane - Brand Showcase (Matching Admin Portal Design) */}
      <div className="w-1/2 relative bg-gradient-to-br from-[#002957] via-[#092c53] to-[#1e40af] overflow-hidden flex items-center justify-center p-12 text-white">
      ...
      {/* Right Pane - Form Login (Matching Admin Form Design) */}
      <div className="w-1/2 flex items-center justify-center p-12 lg:p-16">
        <div className="w-full max-w-md bg-white rounded-[2.5rem] p-10 shadow-sm border border-slate-200/80 space-y-6">
          {/* Logo & Header */}
