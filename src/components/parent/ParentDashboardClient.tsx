  ...
  return (
    <div className="space-y-6 w-full pb-14 max-w-full mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
        ...
        <div className="lg:col-span-4 bg-white p-6 sm:p-7 rounded-[2rem] border border-slate-200/80 shadow-2xs flex flex-col justify-between gap-4">
          <div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-in fade-in">
          <div className="bg-white rounded-[2rem] w-full max-w-lg shadow-2xl border border-slate-100 overflow-hidden">
            ...
            <div className="p-6 space-y-4 text-xs leading-relaxed text-slate-600">
              <p>
                Untuk mengunduh dan mencetak <strong>Kartu Peserta Ujian</strong>, madrasah memberlakukan ketentuan administrasi minimal sebagai berikut:
              </p>
              ...
              <div className="pt-2 flex justify-end">
                <button
                  onClick={() => setShowExamReqModal(false)}
                  className="px-5 py-2 rounded-full bg-blue-600 text-white font-bold hover:bg-blue-700 transition cursor-pointer"
                >
                  Saya Mengerti
                </button>
              </div>
