    ...
    <div className="w-full min-h-screen bg-[#f4f7fb]">
      <div className="md:hidden">
        ...
        <div className="px-4 relative z-20" style={{ marginTop: '-35px' }}>
          <div className="bg-white rounded-2xl p-1.5 shadow-xl border border-slate-100 flex gap-1 mb-4">
            {[1,2,3,4].map((i) => (
              <div key={i} className="flex-1 h-10 rounded-xl bg-slate-100 animate-pulse" />
            ))}
          </div>
          {[1,2,3,4].map((i) => (
